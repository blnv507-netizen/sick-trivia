...
const BANK = [
  ...
  { cat: "مين الشخصية؟", d: 2, q: "مين هذي الشخصية؟", a: "George W. Bush", alt: ["جورج بوش الابن", "بوش"], img: "/img/perswon-GeorgeWBushmid.webp", info: "رئيس أمريكا وقت هجمات 11 سبتمبر وحربي أفغانستان والعراق." },
  // ---- خمّن اللعبة ----
  { cat: "خمّن اللعبة", d: 3, q: "من أي لعبة هذي الصورة؟", a: "The Simpsons", alt: ["سيمبسونز", "The Simpsons Hit & Run"], img: "/img/game-%20The%20Simpsonshard.webp", info: "لعبة مبنية على المسلسل الكرتوني الأشهر، وأسلوبها مستوحى من GTA." },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: سورة يطلق عليها أخت الطويلتين؟", a: "الأعراف" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الألف: غزوة جُرح فيها الرسول ﷺ وكُسرت رباعيته وأُشيع أنه قُتل؟", a: "أحد" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: أول من جمع القرآن بين لوحين؟", a: "أبو بكر الصديق" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: كنية حمزة بن عبدالمطلب سيد الشهداء؟", a: "أبو عمارة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: من القائل: ما أحد يحمل محبرة إلا وللشافعي عليه منّة؟", a: "أحمد بن حنبل" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: يُطلق على صوت المرجل؟", a: "أزيز" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الألف: لقب أطلقه أهل مكة على النبي ﷺ قبل البعثة؟", a: "الأمين" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: صحابي فرض له عمر أكثر مما فرض لابنه، وقال: كان أحبّ لرسول الله منك؟", a: "أسامة بن زيد" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: الصحابية الملقبة بمهاجرة الهجرتين؟", a: "أسماء بنت عميس" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: حيوان يُطلق عليه «أسامة»؟", a: "الأسد" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: شاعر جاهلي لُقّب قبل موته بذي القروح؟", a: "امرؤ القيس" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: من القائل: فيا ليت الشباب يعود يومًا؟", a: "أبو العتاهية" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الألف: كنية آدم عليه السلام؟", a: "أبو البشر" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: من القائل: ما الحب إلا للحبيب الأول؟", a: "أبو تمام" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الألف: مؤسس علم الاجتماع وصاحب «العبر وديوان المبتدأ والخبر»؟", a: "ابن خلدون" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: أول من سمّى القرآن مصحفًا؟", a: "أبو بكر الصديق" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الألف: الاسم الذي كان يُطلق على إسبانيا قديمًا؟", a: "الأندلس" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: البحر الذي يفصل إيطاليا عن البلقان؟", a: "الأدرياتيكي" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: من الصحابة لُقّب بسيد القرّاء؟", a: "أُبيّ بن كعب" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: قائد موقعة الجسر بين المسلمين والفرس؟", a: "أبو عبيد الثقفي" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: سيّدا كهول أهل الجنة: عمر و…؟", a: "أبو بكر الصديق" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الألف: العملة البرتغالية قبل اليورو؟", a: "إسكودو" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الباء: سورة يُطلق عليها سنام القرآن؟", a: "البقرة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الباء: من بحور الشعر العربي؟", a: "البسيط" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الباء: شاعر عباسي مات تحت ضرب السياط؟", a: "بشار بن برد" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الباء: يُطلق على الولد الأول؟", a: "البِكر" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الباء: وحدة طول تساوي جزءًا من اثني عشر من القدم؟", a: "البوصة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الباء: لقب الشاعر العباسي أبي عبادة الوليد بن عبيد الطائي؟", a: "البحتري" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الباء: معنى «الزمهرير» في القرآن؟", a: "البرد الشديد" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الباء: دولة تملك حق النقض بمجلس الأمن؟", a: "بريطانيا" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف التاء: سورة ابتدأت باسم ثمرتين؟", a: "التين" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف التاء: صحابي يُكنى بأبي رُقيّة، كان نصرانيًا فأسلم وتوفي بفلسطين؟", a: "تميم الداري" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف التاء: أكمل: تاج المروءة…؟", a: "التواضع" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف التاء: الفرويدية مدرسة…؟", a: "التحليل النفسي" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف التاء: آية الملك التي منحها الله لطالوت؟", a: "تابوت" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف التاء: مكوك فضائي أمريكي انفجر بعد إطلاقه 1986؟", a: "تشالنجر" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف التاء: مدينة إيرانية فيها المسجد الأزرق؟", a: "تبريز" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف التاء: لقب الشاعر الصعلوك ثابت بن جابر؟", a: "تأبط شرًا" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الثاء: يُطلق على المرأة التي سبق لها الزواج؟", a: "ثيّب" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الثاء: مولى رسول الله ﷺ؟", a: "ثوبان" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الثاء: أول من دخل الكعبة ملبيًا؟", a: "ثمامة بن أثال" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الثاء: مضاد حيوي طبيعي يُستخدم بالطعام والدواء؟", a: "الثوم" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الثاء: لُقّب بخطيب الرسول ﷺ؟", a: "ثابت بن قيس" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الثاء: يُطلق على الجماعة من الناس؟", a: "ثلة" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الثاء: أول من أرضعت رسول الله ﷺ؟", a: "ثويبة" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الثاء: بمعنى الهلاك والخسران؟", a: "الثبور" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الجيم: ذروة سنام الإسلام؟", a: "الجهاد" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الجيم: البئر الذي لم يُبنَ بالحجارة؟", a: "جُبّ" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الجيم: الاسم الحقيقي للشاعر الملقب بالحطيئة؟", a: "جرول بن أوس" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الجيم: وحدة انتقال الصفات الوراثية؟", a: "جينات" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الجيم: من أسماء الصخر؟", a: "جلمود" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الجيم: مخترع آلة التصوير الفوتوغرافي التجارية؟", a: "جورج إيستمان" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الجيم: معجم مشهور لابن دريد البصري؟", a: "الجمهرة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: سورة ورد فيها ذكر الذباب؟", a: "الحج" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: غزوة عقد الرسول ﷺ لواءها لعلي بن أبي طالب؟", a: "حمراء الأسد" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: امرأة جاهلية ضُرب بها المثل في صدق الخبر؟", a: "حذام" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الحاء: وحدة قياس القدرة تُقاس بها المحركات؟", a: "الحصان" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: صحابي انتدبه النبي ﷺ ليأتيه بخبر المشركين بالأحزاب؟", a: "حذيفة بن اليمان" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: يُطلق على صوت المحتضر؟", a: "حشرجة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: شاعر اشتهر بالهجاء وحبسه عمر بن الخطاب؟", a: "الحطيئة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: تلميذ الشافعي صاحب المسند، ومذهبه…؟", a: "الحنبلي" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: قرية عراقية كردية قُصفت بالكيماوي؟", a: "حلبجة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: حامل رسالة النبي ﷺ إلى المقوقس؟", a: "حاطب بن أبي بلتعة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الحاء: من عجائب الدنيا السبع القديمة بالعراق؟", a: "حدائق بابل المعلقة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: زوجة النبي ﷺ المذكورة مع عائشة بسورة التحريم؟", a: "حفصة بنت عمر" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: من القائل: الأم مدرسة إذا أعددتها أعددت شعبًا طيب الأعراق؟", a: "حافظ إبراهيم" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: المطبوعة التي تصدر كل عام؟", a: "حولية" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: يُطلق على صغير الضبّ؟", a: "الحِسل" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الحاء: من أقسام الكلمة بالنحو؟", a: "الحرف" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: مدينة سورية فيها قبر خالد بن الوليد؟", a: "حمص" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: زوج حليمة السعدية مرضعة النبي ﷺ؟", a: "الحارث" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: صحابي قال بعد إصابته: فزت ورب الكعبة؟", a: "حرام بن ملحان" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: المكان الذي سكنته إرم ذات العماد؟", a: "حضرموت" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: لقب الخليفة الأموي مروان بن محمد؟", a: "الحمار" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: مؤسس جماعة الإخوان المسلمين؟", a: "حسن البنا" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الحاء: شاعر جاهلي من أصحاب المعلقات دافع عن قبيلته أمام عمرو بن هند؟", a: "الحارث بن حلزة" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الخاء: بقايا ما تهدّم من المساكن، وضد العمران؟", a: "الخراب" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الخاء: وسيلة لتمثيل سطح الأرض على لوحة مستوية؟", a: "الخريطة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الخاء: صوت النمر؟", a: "خرخرة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الخاء: اللفظ العربي لعنصر الزنك؟", a: "خارصين" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الخاء: من القائل: فلا نامت أعين الجبناء؟", a: "خالد بن الوليد" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الخاء: كم عين للنحلة؟", a: "خمس" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الخاء: مرادف للخوف؟", a: "الخشية" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الخاء: اصطلاح نحوي لما يُسند إلى المبتدأ؟", a: "الخبر" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الخاء: الاسم الذي يُطلق على المشرق والمغرب معًا؟", a: "الخافقان" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الخاء: الصحابية التي فقدت أبناءها وصبرت؟", a: "الخنساء" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الخاء: ما يُقصد بمصطلح «الفوبيا»؟", a: "الخوف" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الدال: بمعنى المكر؟", a: "الدهاء" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الدال: أول وحدة عملة بتاريخ الإسلام؟", a: "الدينار" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الدال: طبقات الجنة درجات وطبقات النار…؟", a: "دركات" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الدال: بمعنى حسن الخلق وراقي الصفات؟", a: "دماثة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الدال: يُطلق على أتباع الطرق الصوفية؟", a: "دراويش" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الدال: صوت النمل؟", a: "دبيب" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الدال: يُطلق على الأسد القوي الشجاع؟", a: "درغام" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الذال: بمعنى السهو وسرحان العقل؟", a: "الذهول" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الذال: حشرة ذُكرت بالقرآن؟", a: "الذباب" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الذال: يوصف به نزول الدمع من العين؟", a: "ذرف" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الذال: بمعنى الخوف والفزع؟", a: "ذعر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الذال: صفة تدل على الفطنة والحفظ معًا؟", a: "الذهن" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الذال: الذبح أو النحر بشروطه الشرعية؟", a: "ذكاة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الذال: فصاحة اللسان وقوة عربيته؟", a: "ذلاقة اللسان" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الذال: توجب غضب الرب وتمنع الرزق؟", a: "الذنوب" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الذال: معركة قادها خالد بن الوليد ضد الفرس؟", a: "ذات السلاسل" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الذال: الملك الصالح الذي ملك الأرض وذُكر بالقرآن؟", a: "ذو القرنين" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الراء: نوع من الأشعة الحديثة لتصوير الدماغ؟", a: "الرنين المغناطيسي" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الراء: الرمي بالحجارة حتى الموت؟", a: "الرجم" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الراء: باطن كف اليد باللغة؟", a: "راحة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الراء: الاسم الفارسي لدفتر تقويم السنوات والأيام؟", a: "روزنامة" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الراء: يُطلق على الطفل حتى يبلغ السنتين؟", a: "رضيع" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الراء: النفخة الأولى بالصور يوم القيامة؟", a: "الراجفة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الراء: الباب الذي يدخل منه الصائمون يوم القيامة؟", a: "الريان" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الراء: ما هو الشرك الأصغر؟", a: "الرياء" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الراء: من أمراض العين؟", a: "رمد" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الزاي: اهتزاز الأرض وارتجافها؟", a: "زلزال" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الزاي: معنى كلمة «بترول»؟", a: "زيت الصخر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الزاي: طعام أهل النار؟", a: "الزقوم" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الزاي: لقب سيدة نساء أهل الجنة؟", a: "الزهراء" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الزاي: الملائكة الموكلة بدفع أهل النار إليها؟", a: "الزبانية" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الزاي: يُطلق على الوقت قليلًا كان أم كثيرًا؟", a: "الزمن" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الزاي: أول من سلّ سيفًا بالإسلام؟", a: "الزبير بن العوام" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: كم عدد أحزاب القرآن؟", a: "ستون" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف السين: اللباس بالنار كما ورد بالقرآن؟", a: "سرابيل" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف السين: كم سورة افتُتحت بـ«طسم»؟", a: "سورتان" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: كم كان عمر النبي ﷺ حين ماتت أمه؟", a: "ست سنوات" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: مربي الخيل ومروّضه؟", a: "سائس" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: شجرة ذُكرت بالقرآن؟", a: "السدر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف السين: ترك التكلم مع القدرة عليه؟", a: "السكوت" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف السين: وقت بالليل يُستحب الاستغفار فيه؟", a: "السحر" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: أول من كتب «بسم الله الرحمن الرحيم»؟", a: "سليمان عليه السلام" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف السين: المسافة التي يقطعها جسم متحرك بوحدة زمن؟", a: "السرعة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: اسم عين بالجنة؟", a: "سلسبيل" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: بمعنى حفيد أو صاحب نسل؟", a: "سبط" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف السين: الممثل الدبلوماسي لدولة بدولة مضيفة؟", a: "سفير" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: من أسماء جهنم؟", a: "سقر" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: من الثدييات المفترسة وذُكر بالقرآن؟", a: "السبع" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف السين: مؤلف كتاب «تاريخ الخلفاء»؟", a: "السيوطي" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: عالم نحوي مسلم فارسي الأصل، أشهر النحاة؟", a: "سيبويه" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الشين: سورة تُسمى الجامعة؟", a: "الشعراء" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الشين: لقب عمر بن الخطاب المرتبط بالجهاد؟", a: "شيخ المجاهدين" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الشين: القائد الفرنكي الذي أوقف المسلمين ببلاط الشهداء؟", a: "شارل مارتل" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الشين: بمعنى قطع الزوائد وقلمها؟", a: "شذب" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الشين: إحدى مراحل تطور الدودة؟", a: "شرنقة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الشين: أحد الأئمة الأربعة صاحب مذهب فقهي؟", a: "الشافعي" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الصاد: من أقدم الدول المنتجة للبخور واللبان؟", a: "الصومال" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الصاد: الاسم السري لقنبلة هيروشيما؟", a: "الصبي الصغير" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الصاد: لفظ يعبّر عن تحسين مادة صلبة وإخراجها بشكل أفضل؟", a: "صقل" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الصاد: يُطلق على صوت السيوف بالحرب؟", a: "صليل" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الصاد: لفظة بالقرآن تعني منهاج الله وطريقته؟", a: "صبغة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الصاد: صيحة تصمّ الآذان يوم القيامة؟", a: "الصاخة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الصاد: من يدخلون الجنة من باب الريان؟", a: "الصائمون" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الصاد: الخمس التي لا سادس لها؟", a: "الصلوات" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الصاد: آلة ينفخ فيها إسرافيل يوم القيامة؟", a: "الصور" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الصاد: صوت الفرس؟", a: "صهيل" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الصاد: وصف للملائكة ورد بالقرآن؟", a: "الصافات" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الصاد: حجر كانت العرب تشعل به النار؟", a: "الصوان" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: بخار الماء الكثيف يغشى الأرض كالدخان؟", a: "الضباب" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الضاد: من أسماء الأسد من أربعة حروف؟", a: "ضيغم" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الضاد: نبات ذُكر بسورة الغاشية وهو طعام أهل النار؟", a: "الضريع" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: بمعنى ضاع وتاه؟", a: "ضلّ" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: القوة التي يحدثها عمود الهواء على نقطة؟", a: "الضغط الجوي" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: صفة النصارى المذكورة بسورة الفاتحة؟", a: "الضالين" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الضاد: من أسماء الأسد من خمسة حروف؟", a: "ضرغام" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: من مراتب صحة الحديث؟", a: "الضعيف" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الضاد: تصحيح الكتاب وتدقيقه وتشكيله؟", a: "ضبط" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: من معجزات موسى عليه السلام أمام فرعون؟", a: "الضفادع" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: الحاجة أو الشدة التي لا مدفع لها؟", a: "ضرورة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: السورة المسماة باسم وقت من أوقات الزمن؟", a: "الضحى" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الضاد: كلمة مرادفة للحقد؟", a: "ضغينة" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الطاء: الصحابي المعروف بذي النور؟", a: "الطفيل بن عمرو الدوسي" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الطاء: الوصف الوارد بالحديث للقطط؟", a: "الطوّافون" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الطاء: جبل أقسم الله به بالقرآن؟", a: "الطور" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الطاء: الخضرة التي تعلو الماء الراكد؟", a: "طحلب" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الطاء: من أسماء يوم القيامة؟", a: "الطامة" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الطاء: أول باب بكتب الفقه؟", a: "الطهارة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الطاء: شعب مسلم يضع رجاله لثامًا أزرق طوال الوقت؟", a: "الطوارق" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الطاء: المدينة التي رحل إليها النبي ﷺ قبل المدينة؟", a: "الطائف" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الطاء: أين كلّم الله موسى عليه السلام؟", a: "طور سيناء" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الطاء: صوت النحل أو الذبابة عند طيرانها؟", a: "طنين" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الظاء: نهى الله عنه وقال إن بعضه إثم؟", a: "الظن" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الظاء: من الصلوات الخمس؟", a: "ظهر" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الظاء: ما يُطلق على ذكر النعام؟", a: "ظليم" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الظاء: عكس كلمة باطنة؟", a: "ظاهرة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الظاء: مذهب فقهي قديم يأخذ بظاهر النص فقط؟", a: "الظاهرية" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: بماذا وصف يونس عليه السلام نفسه ببطن الحوت؟", a: "الظالمين" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: بمعنى فاز ونجح بتحصيله؟", a: "ظفر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الظاء: بالنحو: اسم دلّ على زمان الحدث أو مكانه؟", a: "ظرف" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: ماذا كان يُطلق على المحيط الأطلسي قديمًا؟", a: "بحر الظلمات" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: الغلبة والفوز والقهر؟", a: "الظفر" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: المعين والمساعد؟", a: "ظهير" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: باللغة بمعنى دام واستمر؟", a: "ظلّ" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: من محافظات سلطنة عُمان؟", a: "ظفار" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الظاء: يدخل فيه المتحابون بالله يوم القيامة؟", a: "ظل عرش الرحمن" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: من يُلقّب بخامس الخلفاء الراشدين؟", a: "عمر بن عبدالعزيز" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: قائد غزوة ذات السلاسل؟", a: "عمرو بن العاص" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: اللقب الذي أُطلق على القارة الأمريكية بعد اكتشافها؟", a: "العالم الجديد" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: يوم صيامه يكفّر السنة الماضية ونجّى الله فيه موسى؟", a: "عاشوراء" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: التوراة هي العهد القديم، فما الإنجيل؟", a: "العهد الجديد" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: من الحشرات التي ذُكرت بالقرآن وسُميت بها سورة؟", a: "العنكبوت" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: من أحفاد نوح وإليه تُنسب العرب؟", a: "عدنان" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: صوت الذئب؟", a: "عواء" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: المرأة التي لم تتزوج؟", a: "عذراء" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: معركة بين المسلمين والتتار بقيادة قطز؟", a: "عين جالوت" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: لغة اليهود؟", a: "العبرية" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: إذا طال قصُر، فما هو؟", a: "العمر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: مادة قرن الفيل؟", a: "العاج" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: طعام المولود باليوم السابع؟", a: "العقيقة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: الاسم الحقيقي لأبي جهل؟", a: "عمرو بن هشام" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف العين: اسم العام الذي وُلد فيه النبي ﷺ؟", a: "عام الفيل" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف العين: الخط الذي كُتب به المصحف؟", a: "العثماني" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: أحد أسماء الأسد؟", a: "الغضنفر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الغين: باب من أبواب الشعر ملأ به الشعراء دواوينهم؟", a: "الغزل" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الغين: بمصطلح الحديث: ما رواه راوٍ واحد؟", a: "غريب" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: العرب النصارى حلفاء الروم بالجاهلية؟", a: "الغساسنة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: صوت النائم؟", a: "غطيط" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: اسم من أربعة حروف إذا حذفت منه حرفًا زال؟", a: "غزال" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: لقب الصحابي حنظلة بن أبي عامر؟", a: "غسيل الملائكة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: من أسماء يوم القيامة ورد بالقرآن؟", a: "الغاشية" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: مجاوزة الأمر المحدود بالدين؟", a: "الغلو" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الغين: صوت الماء المتحرك بحلق الإنسان؟", a: "الغرغرة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الغين: لفظ يقصد به الزمن الماضي شديد القدم؟", a: "الغابر" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الفاء: أعلى درجات الجنة؟", a: "الفردوس" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الفاء: الفقر وقلة ذات اليد؟", a: "الفاقة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الفاء: سورة غير الفاتحة تبدأ بالحمد لله؟", a: "فاطر" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الفاء: عالم رياضيات إغريقي نظريته بالمثلث القائم تُدرّس لليوم؟", a: "فيثاغورس" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الفاء: من أكثر أهل الجنة؟", a: "الفقراء" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الفاء: طريقة موت أخبر النبي ﷺ بكثرتها آخر الزمان؟", a: "الفجأة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الفاء: صوت الأفعى؟", a: "فحيح" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الفاء: عيد من أعياد النصارى؟", a: "الفصح" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: أول ولد لآدم عليه السلام؟", a: "قابيل" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: الوصف الذي وصف به النبي ﷺ النساء؟", a: "القوارير" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: بأي مكان يكون الخريف قبل الصيف والخادم قبل السيد؟", a: "القاموس" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: الاسم الذي يُطلق على مولّدة النساء؟", a: "قابلة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: بمعنى تتبّع أثره ولحقه؟", a: "قصّه" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف القاف: من أصحاب القراءات السبع؟", a: "قالون" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: حشرة تصيب فروة الرأس أو شعر الحيوانات؟", a: "القراد" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: اسم ناقة النبي ﷺ؟", a: "القصواء" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف القاف: مسمى لأدوات الكتابة من ورق وأقلام؟", a: "قرطاسية" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف القاف: معلم من معالم المسجد الأقصى بقبته الذهبية؟", a: "قبة الصخرة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف القاف: أول مسجد بالإسلام؟", a: "قباء" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الكاف: ملك مزّق كتاب النبي ﷺ فدعا عليه؟", a: "كسرى" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الكاف: أصل القائد صلاح الدين الأيوبي؟", a: "كردي" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الكاف: صفة أخرجت إبليس من الجنة؟", a: "الكِبر" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الكاف: لقب موسى عليه السلام؟", a: "كليم الله" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف اللام: اسم من أسماء الفضة؟", a: "لُجين" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف اللام: جسم مستطيل متحرك خطره عظيم وبسببه يُكبّ الناس بالنار؟", a: "اللسان" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف اللام: اليهودي الذي سحر النبي ﷺ؟", a: "لبيد بن الأعصم" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف اللام: سيد الطعام؟", a: "اللحم" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف اللام: المتفرعة من اللغة الأم تتداولها الشعوب بإقليم محدود؟", a: "اللهجة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف اللام: كلمة مناداة تعبّر عن الخضوع بالحج؟", a: "لبيك" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف اللام: النبي الذي آمن بنبي معاصر له؟", a: "لوط" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف اللام: العالم باللغة المتفقه فيها؟", a: "لغوي" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف اللام: أطول كلمة بالقرآن؟", a: "ليستخلفنهم" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الميم: أمر خارق للعادة يجريه الله على أيدي الأنبياء؟", a: "المعجزة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الميم: من أعلم هذه الأمة بالحلال والحرام؟", a: "معاذ بن جبل" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الميم: سورة تُسمى سورة الدين؟", a: "الماعون" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الميم: أين يقع مقر رابطة العالم الإسلامي؟", a: "مكة المكرمة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الميم: من هم الزبانية؟", a: "ملائكة العذاب" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الميم: أقصر آية بالقرآن؟", a: "مدهامتان" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الميم: الأغشية التي تغلف الأمعاء وتربطها بجدار البطن؟", a: "المساريقا" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الميم: ماذا تُسمى الميتة بالضرب؟", a: "الموقوذة" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف النون: الحشرة التي تكلمت بالقرآن فتبسم سليمان من قولها؟", a: "النملة" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف النون: عروق الفؤاد والقلب؟", a: "نياط" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف النون: الدابة التي أُرسلت إلى ثمود؟", a: "ناقة الله" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف النون: لقب صلاح الدين الأيوبي؟", a: "الناصر" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف النون: الرئيس الأمريكي الذي استقال بفضيحة ووترغيت؟", a: "نيكسون" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف النون: صوت الدجاجة؟", a: "نقنقة" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف النون: المثل والنظير؟", a: "الند" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف النون: بمعنى برك الجمل وقعد؟", a: "ناخ" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف النون: حالة طبيعية تتعطل معها القوى ويرتاح فيها البدن؟", a: "النوم" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف النون: أداة استعملها النصارى قديمًا للإعلان عن صلاتهم؟", a: "الناقوس" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: أحد الملكين اللذين ذُكرا بالقرآن مع السحر؟", a: "هاروت" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: الخليفة الذي كان يحج عامًا ويغزو عامًا؟", a: "هارون الرشيد" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الهاء: اسم يُطلق على المئة من الإبل؟", a: "هُنيدة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: المعبد الذي يريد اليهود بناءه مكان المسجد الأقصى؟", a: "هيكل سليمان" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: باللغة: خرق الستر عما وراءه؟", a: "هتك" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: ما يُهدى من النعم إلى الحرم تقربًا لله؟", a: "الهدي" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: أكمل المثل: لكل عالِم…؟", a: "هفوة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الهاء: صوت الموج؟", a: "هدير" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الهاء: النبي الذي بُعث إلى قوم عاد؟", a: "هود" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الهاء: الدولة التي تصل فيها اللهجات لمئات اللهجات؟", a: "الهند" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الواو: حيوان كان ينفخ النار على إبراهيم عليه السلام؟", a: "الوزغ" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الواو: أكمل المثل: الآن حمي…؟", a: "الوطيس" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الواو: كل ما يتصوره الإنسان بداخله وهو غير صحيح؟", a: "الوهم" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الواو: معنى النمارق بالقرآن؟", a: "الوسائد" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الواو: أي الأيام مظنة ليلة القدر برمضان؟", a: "الوتر" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الواو: من شيوخ الإمام الشافعي؟", a: "وكيع بن الجراح" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الواو: أكمل: تعددت الأسباب والموت…؟", a: "واحد" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الواو: الغسل والمسح على أعضاء مخصوصة مع النية؟", a: "الوضوء" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الواو: باللغة: الحلم والرزانة؟", a: "الوقار" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الواو: المطر الذي يخرج من السحاب كما ورد بالقرآن؟", a: "الودق" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الواو: ركن الحج الأعظم؟", a: "الوقوف بعرفة" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الواو: وادٍ بجهنم لكل همّاز لمّاز؟", a: "ويل" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الياء: أكمل: المرء على دين خليله فلينظر أحدكم من…؟", a: "يخالل" },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الياء: الشجر الذي أنبته الله ليونس عليه السلام؟", a: "اليقطين" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الياء: أكمل المثل: إذا أردت أن تُطاع فأمر بما…؟", a: "يُستطاع" },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الياء: النبي الذي اسم والده «متّى»؟", a: "يونس" },
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الياء: نقيض النوم والغفلة؟", a: "اليقظة" },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الياء: عنصر رمادي يميل للزرقة يُستعمل بتطهير الجروح؟", a: "اليود" },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الياء: النبي الذي لم يتزوج قط؟", a: "يحيى" },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الياء: الفتى الذي صاحب موسى عليه السلام؟", a: "يوشع بن نون" },
  ...
  { cat: "بوسات إلدن رينق", d: 2, q: "من إلدن رينق — البوس الفارس اللي على حصان ويحرس بداية العالم المفتوح؟", a: "Tree Sentinel", alt: ["حارس الشجرة"], info: "أول امتحان باللعبة — يقتل المبتدئين ويعلّمهم إن الهروب خيار." },
  ...
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي ينتمي لعائلة Marika لكنه مخفي عن العالم؟", a: "Messmer", alt: ["ميسمر", "Messmer the Impaler", "ميسمير"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي كان مسؤولًا عن حملة الـ Crusade في الـ Realm of Shadow؟", a: "Messmer", alt: ["ميسمر", "Messmer the Impaler", "ميسمير"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي يستخدم الرمح والنار في قتاله؟", a: "Messmer", alt: ["ميسمر", "Messmer the Impaler", "ميسمير"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي عنده عين مغطاة وشعر أحمر؟", a: "Messmer", alt: ["ميسمر", "Messmer the Impaler", "ميسمير"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي اختار أن يُلتهم بدل أن يخضع لإرادة الـ Greater Will؟", a: "Rykard", alt: ["ريكارد", "Rykard Lord of Blasphemy", "لورد البلاسفيمي"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي حوّل الـ Volcano Manor إلى معقل للتمرد على الـ Erdtree؟", a: "Rykard", alt: ["ريكارد", "Rykard Lord of Blasphemy", "لورد البلاسفيمي"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي لقبه مرتبط بتحدّي المقدسات ورفض النظام الذهبي؟", a: "Rykard", alt: ["ريكارد", "Rykard Lord of Blasphemy", "لورد البلاسفيمي"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي قال إن يومًا ما سيصبح كل شيء one flesh؟", a: "Rykard", alt: ["ريكارد", "Rykard Lord of Blasphemy", "لورد البلاسفيمي"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي فقد جزءًا من جسده في معركة قديمة ضد أقوى تنين؟", a: "Bayle", alt: ["بايل", "Bayle the Dread", "بايل الرهيب"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي تمرّد على الـ Dragonlord ورفض الخضوع له؟", a: "Bayle", alt: ["بايل", "Bayle the Dread", "بايل الرهيب"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي قاتل Dragonlord Placidusax ونجا من المواجهة؟", a: "Bayle", alt: ["بايل", "Bayle the Dread", "بايل الرهيب"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي يُعتبر العدو الأكبر لـ Igon؟", a: "Bayle", alt: ["بايل", "Bayle the Dread", "بايل الرهيب"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي كان تنينًا عظيمًا مرتبطًا بأمير الموت؟", a: "Lichdragon Fortissax", alt: ["فورتساكس", "Fortissax", "ليتش دراقون"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي واجه الـ Death داخل أحلام أحد الشخصيات؟", a: "Lichdragon Fortissax", alt: ["فورتساكس", "Fortissax", "ليتش دراقون"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي مرتبط بـ Godwyn والـ Prince of Death؟", a: "Lichdragon Fortissax", alt: ["فورتساكس", "Fortissax", "ليتش دراقون"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي تقاتله داخل حلم Fia؟", a: "Lichdragon Fortissax", alt: ["فورتساكس", "Fortissax", "ليتش دراقون"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي لقبه يجمع بين التنين وشيء مرتبط بالموت؟", a: "Lichdragon Fortissax", alt: ["فورتساكس", "Fortissax", "ليتش دراقون"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي ظلّ يعاني من الـ Frenzied Flame رغم أنه حاول مقاومته؟", a: "Midra", alt: ["ميدرا", "Midra Lord of Frenzied Flame", "لورد الفرنزيد فليم"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي تخلى عن رأسه ليمنع الـ Frenzied Flame من السيطرة عليه؟", a: "Midra", alt: ["ميدرا", "Midra Lord of Frenzied Flame", "لورد الفرنزيد فليم"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي مرتبط بأتباع الـ Three Fingers وفلسفة الـ Frenzied Flame؟", a: "Midra", alt: ["ميدرا", "Midra Lord of Frenzied Flame", "لورد الفرنزيد فليم"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي يتحول في منتصف المعركة من رجل ضعيف إلى Lord مخيف؟", a: "Midra", alt: ["ميدرا", "Midra Lord of Frenzied Flame", "لورد الفرنزيد فليم"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي كان يعاني من ألم شديد بسبب سيف مغروس في رأسه؟", a: "Midra", alt: ["ميدرا", "Midra Lord of Frenzied Flame", "لورد الفرنزيد فليم"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي كانت شقيقتها واحدة من أشهر الشخصيات في الـ Lands Between؟", a: "Rellana", alt: ["ريلانا", "Rellana Twin Moon Knight", "فارسة القمرين"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي تحوّل قتالها في المرحلة الثانية إلى مزيج من السحر والنار؟", a: "Rellana", alt: ["ريلانا", "Rellana Twin Moon Knight", "فارسة القمرين"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي حاربت إلى جانب Messmer في حملته في الـ Realm of Shadow؟", a: "Rellana", alt: ["ريلانا", "Rellana Twin Moon Knight", "فارسة القمرين"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي تستخدم تقنية القمرين التوأمين في أقوى هجماتها؟", a: "Rellana", alt: ["ريلانا", "Rellana Twin Moon Knight", "فارسة القمرين"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق DLC — من هو البوس اللي تركت عائلتها واتبعت Messmer إلى أرض الظلال؟", a: "Rellana", alt: ["ريلانا", "Rellana Twin Moon Knight", "فارسة القمرين"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي يحمل جزءًا من الـ Rune of Death داخل سلاحه؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي كان يُعرف باسم Gurranq تحت هوية مختلفة؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي يحرس شيئًا أخفته Marika عن بقية العالم؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي تسبب سرقته في بداية سلسلة أحداث أدت إلى Night of the Black Knives؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي تواجهه في Crumbling Farum Azula؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي يُعتبر Shadowbound Beast الخاص بـ Marika؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي لقبه مرتبط بالسلاح الذي يحمل قوة الـ Rune of Death؟", a: "Maliketh", alt: ["ماليكيث", "Maliketh the Black Blade", "النصل الأسود"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي كان يَعتبر نفسه من سلالة Godfrey، رغم أن دمه كان أضعف من بقية أفراد العائلة؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي كان يعوّض ضعفه بزراعة أجزاء أجساد المحاربين في جسده؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي هرب من Leyndell بعد هزيمته، ثم اختبأ داخل قلعة بعيدة؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي قطع رأسه بنفسه ليحاول الهروب من الموت؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي استبدل أحد ذراعيه بذراع تنين أثناء المعركة؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي جمع أطرافًا من أجساد الآخرين ليصنع لنفسه قوة أكبر؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي يحكم Stormveil Castle رغم أن أقاربه الأقوى ينظرون إليه باحتقار؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي تقدر تسمعه يتحدث عن نفسه كأنه أعظم من يكون، رغم أنه يُعتبر الأضعف بين الـ Demigods؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي في المرحلة الثانية يقطع ذراعه ويستخدم رأس تنين كسلاح؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — من هو البوس اللي لقبه مرتبط بفعلٍ يجعله يضيف أجساد الآخرين إلى جسده؟", a: "Godrick", alt: ["غودريك", "Godrick the Grafted", "جودريك"] },
  ...
  { cat: "بوسات إلدن رينق", d: 3, q: "بوس تقاتله بسطح مائي والانعكاس جزء من جو المعركة، وهو ساحرة القمر بإلدن رينق؟", a: "Rennala", alt: ["رينالا"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من إلدن رينق — بوس يستدعي نسخ منه كل ما نزلت صحته، ثنائي بأزياء بيضاء وسوداء؟", a: "Godskin Duo", alt: ["غودسكن", "جودسكين"] },
  ...
  { cat: "بوسات إلدن رينق", d: 3, q: "بوس إلدن رينق اللي يمثل تنين البرق العملاق بجبل جيلمير؟", a: "Fortissax", alt: ["فورتساكس"] },
  { cat: "بوسات إلدن رينق", d: 3, q: "من نايترين — البوس اللي يمثل الوحش الأول والأصعب بالليلة الثالثة؟", a: "Nightlord", alt: ["نايتلورد", "اللورد"] },
  ...
  { cat: "بوسات إلدن رينق", d: 3, q: "بوس إلدن رينق DLC اللي يمثل أسدًا يرقص بعنصرين متغيرين؟", a: "Dancing Lion", alt: ["الأسد الراقص"] },
  ...
  { cat: "بوسات إلدن رينق", d: 3, q: "من نايترين — البوس اللي يعتبر التنين الجليدي ويهاجم من السما بالليلة الثالثة؟", a: "Adel", alt: ["أدل", "ادل"] },
...
const INVENTIVE = ["مين الشخصية؟", "خمّن البوس", "خمّن اللعبة", "بوسات إلدن رينق", "لعبة الحروف", "منطق وألغاز", "أمثال ومصطلحات", "طعام ومطبخ", "حيوانات", "فضاء", "جسم الإنسان", "السعودية", "سيارات", "اختراعات", "أعلام", "شكل ورسم", "وين المكان؟", "مين قالها؟", "وش الغرض؟",
