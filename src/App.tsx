...
const INVENTIVE = ["مقولات", "مين الشخصية؟", "خمّن البوس", "خمّن اللعبة", "بوسات إلدن رينق", "لعبة الحروف", "منطق وألغاز", "أمثال ومصطلحات", "طعام ومطبخ", "حيوانات", "فضاء", "جسم الإنسان", "السعودية", "سيارات", "اختراعات", "أعلام", "شكل ورسم", "وين المكان؟", "مين قالها؟", "وش الغرض؟",
