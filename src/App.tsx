...
const BANK = [
  ...
  { cat: "لعبة الحروف", d: 1, q: "بحرف الخاء: الغاز اللي تحتاجه النار عشان تشتعل؟", a: "الأكسجين", alt: ["اكسجين"], info: "من مثلث الحريق: وقود + حرارة + أكسجين. اقطع واحدًا تنطفئ." },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: الوعاء الدموي الأكبر بجسمك الخارج من القلب؟", a: "الأورطي", alt: ["الأبهر", "Aorta"] },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الطاء: الطائر الوحيد اللي يقدر يطير للخلف؟", a: "الطنان", alt: ["طائر الطنان"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الكاف: المادة اللي تعطي الفلفل حرارته؟", a: "الكابسيسين", alt: ["كابسيسين", "Capsaicin"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الواو: أغلى لحم بالعالم من اليابان بتشحيم رخامي؟", a: "واغيو", alt: ["Wagyu", "واقيو"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الغين: البروتين بالقمح اللي يعطي العجين مرونته؟", a: "الغلوتين", alt: ["جلوتين", "Gluten"] },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الباء: أداة تقيس الضغط الجوي وتتنبأ بالطقس؟", a: "البارومتر", alt: ["بارومتر", "Barometer"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الألف: أول مبرمجة بالتاريخ وبنت الشاعر بايرون؟", a: "آدا", alt: ["ادا", "Ada Lovelace"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف السين: مقياس شدة الزلازل المعروف بالدرجات؟", a: "سلم ريختر", alt: ["ريختر", "Richter"] },
  ...
  { cat: "لعبة الحروف", d: 3, q: "بحرف الشين: مقياس حرارة الفلفل الحار سُمّي على كيميائي بحرف الـS — عرّبه؟", a: "سكوفيل", alt: ["Scoville"] },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الجيم: مضيق يفصل إسبانيا عن المغرب وسُمّي على قائد فاتح؟", a: "جبل طارق", alt: ["Gibraltar"] },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الكاف: نظام ألوان الطباعة الرباعي بالإنجليزي؟", a: "CMYK", alt: ["سي ام واي كي"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الفاء: العالم اللي اكتشف البنسلين بالصدفة؟", a: "فلمنغ", alt: ["فليمنج", "Fleming"], info: "ترك أطباقه قبل إجازة، ورجع فلقى عفنًا قتل البكتيريا حوله." },
  ...
  { cat: "لعبة الحروف", d: 2, q: "بحرف الميم: العالم اللي رتّب الجدول الدوري وترك فراغات لعناصر لم تُكتشف؟", a: "مندليف", alt: ["Mendeleev"], info: "تنبأ بخصائص عناصر لم تُكتشف بعد، ولما اكتُشفت طابقت تنبؤاته بدقة مذهلة." },
  { cat: "لعبة الحروف", d: 3, q: "بحرف الغين: أكبر قمر بالمجموعة الشمسية وأكبر من عطارد؟", a: "غانيميد", alt: ["جانيميد", "Ganymede"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الميم: الوثيقة الإنجليزية 1215 اللي حدّت سلطة الملك؟", a: "ماجنا كارتا", alt: ["الماجنا كارتا", "Magna Carta"] },
  { cat: "لعبة الحروف", d: 3, q: "بحرف النون: الوحدة الوظيفية بالكلية المسؤولة عن الفلترة؟", a: "النفرون", alt: ["نفرون", "Nephron"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الأف: المسبار اللي غادر المجموعة الشمسية وأُطلق 1977؟", a: "فوياجر", alt: ["Voyager", "فوييجر"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الحاء: نظرية تفسر تمدد الكون من نقطة واحدة؟", a: "حادثة الانفجار العظيم", alt: ["الانفجار العظيم", "Big Bang"] },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الباء: أقدم عاصمة مأهولة باستمرار بالعالم — تنافس دمشق وتبدأ بـB بالإنجليزي؟", a: "بيبلوس", alt: ["Byblos", "جبيل"] },
