...
const BANK = [
  ...
  { cat: "بوسات السولز", d: 2, q: "من إلدن رينق — البوس الفارس اللي على حصان ويحرس بداية العالم المفتوح؟", a: "Tree Sentinel", alt: ["حارس الشجرة"], info: "أول امتحان باللعبة — يقتل المبتدئين ويعلّمهم إن الهروب خيار." },
  ...
  { cat: "أزياء الشخصيات", d: 2, q: "بدلة سوداء كاملة وأذنان مدببتان وعباءة ورمز خفاش على الصدر؟", a: "Batman", alt: ["باتمان"], info: "الوحيد بين أبطال DC الكبار بلا قوى خارقة — يعتمد على المال والتدريب." },
  { cat: "لعبة الحروف", d: 1, q: "بحرف القاف: العضو اللي ينبض بصدرك ويضخ الدم؟", a: "القلب", alt: ["قلب"], info: "ينبض نحو 100 ألف مرة باليوم بلا توقف." },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الشين: النجم اللي يعطينا الضوء والحرارة؟", a: "الشمس", alt: ["شمس"], info: "نجم متوسط الحجم، ضوءه يوصلنا خلال 8 دقايق." },
  { cat: "لعبة الحروف", d: 1, q: "بحرف الجيم: الحيوان الملقب سفينة الصحراء؟", a: "الجمل", alt: ["جمل"], info: "سنامه يخزّن دهونًا مو ماء — والدهون تتحول لطاقة وماء عند الحاجة." },
  { cat: "لعبة الحروف", d: 2, q: "بحرف الخاء: الغاز اللي تحتاجه النار عشان تشتعل؟", a: "الأكسجين", alt: ["اكسجين"], info: "من مثلث الحريق: وقود + حرارة + أكسجين. اقطع واحدًا تنطفئ." },
  ...
  { cat: "منطق وألغاز", d: 2, q: "كيلو حديد وكيلو قطن — أيهما أثقل؟", a: "متساويان", alt: ["نفس الوزن", "متساوين"], info: "الكتلة وحدة، بس القطن حجمه أكبر فيخدع العين." },
  ...
  { cat: "أمثال ومصطلحات", d: 2, q: "وش معنى: يضرب أخماسًا لأسداس؟", a: "يحتار ويتردد", alt: ["الحيرة", "محتار"], info: "أصلها من حساب الإبل قديمًا وطول التفكير بالورد." },
  ...
  { cat: "طعام ومطبخ", d: 2, q: "وش الجزء من النخلة اللي نأكله؟", a: "التمر", alt: ["الثمرة", "البلح"], info: "وفيه الجُمّار (قلب النخلة) يؤكل كمان لكنه يقتل النخلة." },
  ...
  { cat: "فضاء", d: 2, q: "كم يستغرق دوران الأرض حول نفسها؟", a: "24 ساعة", alt: ["يوم", "24"], info: "بالضبط 23 ساعة و56 دقيقة — والفرق يتراكم فنضيف يومًا كل 4 سنين." },
  ...
  { cat: "جسم الإنسان", d: 2, q: "وش السائل الأحمر اللي يجري بعروقك؟", a: "الدم", alt: ["دم"], info: "لونه أحمر بسبب الحديد بالهيموغلوبين." },
  ...
  { cat: "السعودية", d: 2, q: "وش عملة السعودية؟", a: "الريال", alt: ["ريال"], info: "مربوط بالدولار منذ 1986 بسعر ثابت 3.75." },
  ...
  { cat: "سيارات", d: 2, q: "وش السائل اللي تعبّيه بالسيارة عشان تمشي؟", a: "البنزين", alt: ["الوقود", "بنزين"], info: "والديزل بديل يشتغل بالضغط بدل الشرارة." },
  ...
  { cat: "اختراعات", d: 2, q: "مين اخترع الطائرة؟", a: "الأخوان رايت", alt: ["رايت", "Wright"], info: "أول رحلة 1903 استمرت 12 ثانية فقط." },
  { cat: "اختراعات", d: 2, q: "وش الاختراع اللي حفظ الأكل بالتبريد؟", a: "الثلاجة", alt: ["البراد"], info: "تسحب الحرارة من الداخل وترميها خارجًا — ما تصنع برودة." },
  { cat: "أعلام", d: 1, q: "وش لون علم السعودية الأساسي؟", a: "أخضر", alt: ["الأخضر"], info: "واللون الأخضر مرتبط تاريخيًا بالإسلام." },
  { cat: "أعلام", d: 1, q: "علم فيه هلال ونجمة — من أي دين رمزه غالبًا؟", a: "الإسلام", alt: ["إسلامي", "مسلم"], info: "الهلال صار رمزًا للدول الإسلامية من العهد العثماني." },
  { cat: "أعلام", d: 2, q: "كم لون بعلم فرنسا؟", a: "3", alt: ["ثلاثة"], info: "أزرق وأبيض وأحمر — من رموز الثورة الفرنسية." },
  ...
  { cat: "شكل ورسم", d: 2, q: "شكل ما له أضلاع ولا زوايا — وش هو؟", a: "الدائرة", alt: ["دائرة"], info: "تُعرّف بأنها كل النقاط على بعد ثابت من مركز." },
  ...
  { cat: "وين المكان؟", d: 2, q: "بلد على شكل حذاء طويل بالبحر المتوسط — وين؟", a: "إيطاليا", alt: ["Italy"], info: "شكل «الجزمة» صار أشهر خريطة يعرفها الناس." },
  { cat: "وين المكان؟", d: 2, q: "أكبر محيط بالعالم يفصل آسيا عن أمريكا — وين؟", a: "المحيط الهادئ", alt: ["الهادي", "Pacific"], info: "مساحته أكبر من كل اليابسة مجتمعة." },
  { cat: "مين قالها؟", d: 1, q: "مين قال «إنما الأعمال بالنيات»؟", a: "النبي محمد", alt: ["الرسول", "محمد ﷺ"], info: "حديث مشهور يُفتتح به كثير من كتب الحديث." },
  ...
  { cat: "مين قالها؟", d: 2, q: "مين قال «العلم في الصغر كالنقش على الحجر»؟", a: "الحسن البصري", alt: ["مثل عربي", "الحسن"], info: "تُنسب للحسن البصري وشاعت كمثل." },
  { cat: "مين قالها؟", d: 2, q: "مين قال «كن أنت التغيير»؟", a: "غاندي", alt: ["Gandhi"], info: "من أشهر عباراته عن الإصلاح الذاتي قبل إصلاح العالم." },
  ...
  { cat: "وش الغرض؟", d: 2, q: "جهاز يبرّد الغرفة بسحب الحرارة منها ورميها برا؟", a: "المكيّف", alt: ["التكييف"], info: "ما يصنع برودة — ينقل الحرارة من مكان لمكان." },
  ...
  { cat: "الرابط المشترك", d: 2, q: "القمر والمريخ والزهرة — وش يجمعهم؟", a: "أجرام بالفضاء", alt: ["الفضاء", "المجموعة الشمسية"], info: "القمر تابع، والمريخ والزهرة كوكبان جاران للأرض." },
  ...
  { cat: "قبل ولا بعد؟", d: 2, q: "أيهما أقدم: الهاتف ولا التلفزيون؟", a: "الهاتف", info: "الهاتف 1876 والتلفزيون بعده بنحو 50 سنة." },
  ...
  { cat: "إيموجي", d: 2, q: "خمّن: ⚽🥅🏟️", a: "كرة القدم", alt: ["فوتبول"], info: "أكثر رياضة شعبية بالعالم." },
  ...
  { cat: "دليلين", d: 2, q: "دليل ١: أبيض ويسيل. دليل ٢: يجي من البقر. وش هو؟", a: "الحليب", alt: ["اللبن"], info: "غني بالكالسيوم وبروتين الكازين." },
  ...
  { cat: "الأغرب", d: 2, q: "مين الغريب: الأسد، النمر، الفهد، الحصان؟", a: "الحصان", info: "الوحيد عاشب — الباقي من فصيلة السنوريات المفترسة." },
  ...
  { cat: "لو كنت مكانك", d: 2, q: "جسمك حرارته مرتفعة وتحس بالبرد — وش يسمّى هذا؟", a: "الحمّى", alt: ["حرارة", "سخونة"], info: "الرجفة محاولة الجسم يرفع حرارته للوصول للنقطة الجديدة." },
  { cat: "بوسات السولز", d: 1, q: "من إلدن رينق — أول بوس ذهبي يوقفك بالقلعة الأولى ويقول لك طموحك أحمق؟", a: "Margit", alt: ["مارغيت"], info: "يظهر لاحقًا باسمه الحقيقي Morgott بالعاصمة." },
  ...
  { cat: "أوفرواتش", d: 2, q: "البطلة D.Va من أي دولة؟", a: "كوريا الجنوبية", alt: ["كوريا"], info: "كانت لاعبة محترفة قبل ما تقود الميكا." },
  ...
  { cat: "أزياء الشخصيات", d: 2, q: "أفرول أزرق وقبعة حمراء وشارب وحرف M؟", a: "Mario", alt: ["ماريو"], info: "الأفرول كان بسبب محدودية ألوان أجهزة الثمانينات." },
  ...
  { cat: "ألعاب فيديو", d: 2, q: "وش أشهر لعبة باتل رويال من Epic Games؟", a: "Fortnite", alt: ["فورتنايت"], info: "بدأت كلعبة تعاونية ضد الزومبي قبل ما يضيفون الباتل رويال." },
  { cat: "أفلام ومسلسلات", d: 1, q: "وش اسم السفينة اللي غرقت بفيلم 1997 الشهير؟", a: "تايتانيك", alt: ["Titanic"], info: "الفيلم بقي الأعلى إيرادًا 12 سنة." },
  { cat: "أفلام ومسلسلات", d: 1, q: "مين مخرج سلسلة أفلام The Dark Knight؟", a: "نولان", alt: ["كريستوفر نولان"], info: "اشتهر بتصوير مشاهد حقيقية بدل المؤثرات قدر الإمكان." },
  { cat: "أفلام ومسلسلات", d: 2, q: "وش الشركة صاحبة أفلام Marvel؟", a: "ديزني", alt: ["Disney", "مارفل"], info: "اشترت مارفل 2009 بأربعة مليارات دولار." },
  { cat: "أفلام ومسلسلات", d: 2, q: "وش المسلسل اللي بطله معلّم كيمياء يصنع المخدرات؟", a: "Breaking Bad", alt: ["بريكنق باد"], info: "شخصيته المستعارة «هايزنبرغ» من عالم فيزياء الكم." },
  ...
  { cat: "تاريخ", d: 1, q: "في أي مدينة وُلد النبي محمد ﷺ؟", a: "مكة", alt: ["مكة المكرمة"], info: "وهاجر منها للمدينة سنة 622 وبها يبدأ التقويم الهجري." },
  ...
  { cat: "منطق وألغاز", d: 2, q: "لو كان عندك 3 تفاحات وأخذت 2 — كم صار عندك؟", a: "2", alt: ["اثنتين"], info: "اللي أخذته هو اللي صار عندك — الفخ بصياغة السؤال." },
  // ---- أفلام (أسئلة حسين) ----
